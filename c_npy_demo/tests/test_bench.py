...
from ..bench import comma_list_to_shape, main
...
def test_comma_list_to_shape_split():
    """Test :func:`c_npy_demo.bench.comma_list_to_shape` splitting behavior.
...
def test_comma_list_to_shape_validity():
    """Check that :func:`c_npy_demo.bench.comma_list_to_shape` shape is valid.
